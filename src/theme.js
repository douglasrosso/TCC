...
const theme = createTheme({
  palette: {
    primary:    { main: '#0ea5a4', light: '#5eead4', dark: '#0b7285' },
    secondary:  { main: '#f97316', light: '#fdba74', dark: '#c2410c' },
  ...
  typography: {
    ...
    subtitle2: { fontWeight: 500, fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '0.05em', color: '#64748b' },
    body2: { color: '#475569' },
  ...
  components: {
    MuiCard: {
      ...
      styleOverrides: {
        root: {
          ...
          '&:hover': { boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.07), 0 2px 4px -2px rgb(0 0 0 / 0.05)' },
    ...
    MuiTableCell: {
      styleOverrides: {
        head: { fontWeight: 600, fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.05em', color: '#64748b', borderBottomColor: '#e2e8f0' },
