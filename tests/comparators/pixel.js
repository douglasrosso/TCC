 ...
 * Alta sensibilidade: detecta até alterações sutis, mas pode gerar
 * mais alertas diante de flutuações de renderização.
 *
...
export async function compare(baselinePath, currentPath, options = {}) {
  ...
  /* Dimensões diferentes → regressão imediata */
